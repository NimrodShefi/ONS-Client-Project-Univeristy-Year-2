INSERT INTO user(first_name, last_name, email, password) VALUES(AES_ENCRYPT("Nimrod", 'key'), AES_ENCRYPT("Shefi", 'key'), AES_ENCRYPT("nimrod@cardiff.ac.uk", 'key'), "$2a$10$Hfi.30gNk2MQFht5FseEzOzMXp3p9WLDFam8NM5gQWSrHoUvrIEYa");            -- pw: "nimpass" roles: USER
INSERT INTO user(first_name, last_name, email, password) VALUES(AES_ENCRYPT("Hannah", 'key'), AES_ENCRYPT("Bonnett", 'key'), AES_ENCRYPT("hannah@cardiff.ac.uk", 'key'), "$2a$10$OMucrxeSJ.7dRqFy6u.TXe2RjE5fEnKPCrlYexWP/bTgTuFPi4x.K");          -- pw: "hanpass" roles: ADMIN
INSERT INTO user(first_name, last_name, email, password) VALUES(AES_ENCRYPT("Mahruk", 'key'), AES_ENCRYPT("Zulfiqar", 'key'), AES_ENCRYPT("mahruk@cardiff.ac.uk", 'key'), "$2a$10$ZL9Jwym3ALO5uYVhh7MtouquWswsuWAJHHXIQu1h1BYqKGyleuabm");         -- pw: "mahpass" roles: USER, AUTHOR
INSERT INTO user(first_name, last_name, email, password) VALUES(AES_ENCRYPT("Sameer", 'key'), AES_ENCRYPT("Shah", 'key'), AES_ENCRYPT("sameer@cardiff.ac.uk", 'key'), "$2a$10$4mab7bDkdp4TSbvYPcPzeu8Jm/P4vREk4AmJ8DCvxEYt0dCb/5/E.");             -- pw: "sampass" roles: AUTHOR
INSERT INTO user(first_name, last_name, email, password) VALUES(AES_ENCRYPT("Jean-Luc", 'key'), AES_ENCRYPT("Picard", 'key'), AES_ENCRYPT("picard@cardiff.ac.uk", 'key'), "$2a$10$GSn7LP4oN4CymVRkfU.YBOAFUjBmhl9B5vyp59yP/vjMeymEsNSVq");   		-- pw: "earlgreyhot" roles: USER, AUTHOR, ADMIN
INSERT INTO user(first_name, last_name, email, password) VALUES(AES_ENCRYPT("Ellen", 'key'), AES_ENCRYPT("Ripley", 'key'), AES_ENCRYPT("ellen@cardiff.ac.uk", 'key'), "$2a$10$Cqv3qCw6WwH02Oms89TDieWJbvrqqWWc6se7Ty7ocsMJ5EwswK7Tu");            -- pw: "password" roles: USER, AUTHOR
INSERT INTO user(first_name, last_name, email, password) VALUES(AES_ENCRYPT("William", 'key'), AES_ENCRYPT("Riker", 'key'), AES_ENCRYPT("william@cardiff.ac.uk", 'key'), "$2a$10$Cqv3qCw6WwH02Oms89TDieWJbvrqqWWc6se7Ty7ocsMJ5EwswK7Tu");            -- pw: "password" roles: USER
INSERT INTO user(first_name, last_name, email, password) VALUES(AES_ENCRYPT("Deanna", 'key'), AES_ENCRYPT("Troi", 'key'), AES_ENCRYPT("deanna@cardiff.ac.uk", 'key'), "$2a$10$Cqv3qCw6WwH02Oms89TDieWJbvrqqWWc6se7Ty7ocsMJ5EwswK7Tu");            -- pw: "password" roles: AUTHOR
INSERT INTO user(first_name, last_name, email, password) VALUES(AES_ENCRYPT("Kara", 'key'), AES_ENCRYPT("Thrace", 'key'), AES_ENCRYPT("kara@cardiff.ac.uk", 'key'), "$2a$10$Cqv3qCw6WwH02Oms89TDieWJbvrqqWWc6se7Ty7ocsMJ5EwswK7Tu");            -- pw: "password" roles: USER, AUTHOR
INSERT INTO user(first_name, last_name, email, password) VALUES(AES_ENCRYPT("Sarah", 'key'), AES_ENCRYPT("Connor", 'key'), AES_ENCRYPT("sarah@cardiff.ac.uk", 'key'), "$2a$10$Cqv3qCw6WwH02Oms89TDieWJbvrqqWWc6se7Ty7ocsMJ5EwswK7Tu");            -- pw: "password" roles: AUTHOR
INSERT INTO user(first_name, last_name, email, password) VALUES(AES_ENCRYPT("Marty", 'key'), AES_ENCRYPT("McFly", 'key'), AES_ENCRYPT("marty@cardiff.ac.uk", 'key'), "$2a$10$Cqv3qCw6WwH02Oms89TDieWJbvrqqWWc6se7Ty7ocsMJ5EwswK7Tu");            -- pw: "password" roles: USER
INSERT INTO user(first_name, last_name, email, password) VALUES(AES_ENCRYPT("Han", 'key'), AES_ENCRYPT("Solo", 'key'), AES_ENCRYPT("han@cardiff.ac.uk", 'key'), "$2a$10$Cqv3qCw6WwH02Oms89TDieWJbvrqqWWc6se7Ty7ocsMJ5EwswK7Tu");            	-- pw: "password" roles: USER, AUTHOR
